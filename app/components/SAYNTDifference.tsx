...
export default function SAYNTDifference() {
  ...
  return (
    <section className="w-full bg-[#020617] text-white py-20 lg:py-32 px-6 relative overflow-hidden">
      {/* Header */}
      ...
      <div className="w-full px-4">
        <div className="relative flex flex-col lg:flex-row items-center justify-around gap-16 lg:gap-0">
          ...
          {/* Left Side - Logo */}
          <div className="flex-shrink-0 lg:mr-20 flex-shrink-0 w-[100px] h-[100px] lg:w-[200px] lg:h-[200px]
             rounded-[28px] border border-[#1F2937]
             flex items-center justify-center bg-transparent">
            <div className="w-[75px] h-[75px] lg:w-[150px] lg:h-[150px]
               rounded-[20px] bg-[#0F172A]
            ...
            {differences.map((item, index) => {
              return (
                <div key={index} className="flex items-start gap-6">
                  {/* Icon Box */}
                  <div
                    className="flex-shrink-0 w-[100px] h-[100px] lg:w-[171px] lg:h-[173px]
             rounded-[28px] border border-[#1F2937]
             flex items-center justify-center bg-transparent"
                  >
                    <div
                      className="w-[75px] h-[75px] lg:w-[125px] lg:h-[125px]
               rounded-[20px] bg-[#0F172A]
               flex items-center justify-center"
                    >
                      <Image
                  ...
                  <div className="flex-1 pt-1">
                    <h3 className="text-[#00FFD2] text-[20px] lg:text-[24px] font-semibold mb-3 leading-tight">
                      {item.title}
                    </h3>
                    <p className="text-white text-[15px] lg:text-[17px] leading-[1.7] font-normal">
                      {item.description}
                    </p>
                  </div>
                </div>
