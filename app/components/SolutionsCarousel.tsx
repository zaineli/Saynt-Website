  ...
  return (
    <section className="w-full py-20 lg:py-24">
        ...
        <div className="w-full border-b border-t border-[#1F1F1F] flex justify-center items-center">
          <div className="max-w-8xl mx-auto flex flex-col lg:flex-row  justify-center ">
            ...
            <div className="flex flex-row lg:flex-col w-full lg:w-[160px] shrink-0 overflow-x-auto lg:overflow-visible">
              {solutions.map((solution, index) => (
                <button
                  ...
                  className={`relative transition-all duration-300 group w-[159.55px] h-[159px] border-r-[1.12px] border-b-[1.12px] border-l-[1.12px] border-solid ${
                    activeIndex === index
                ...
                >
                  {/* Icon */}
                  <div 
                    className="absolute w-[131px] h-[62px] top-[35px] left-[12px]"
                  >
                    <Image
                      src={solution.icon}
                      alt={`Step ${index + 1}`}
                  ...
                  {/* Number */}
                  <span 
                    className={`text-lg font-medium absolute bottom-4 left-0 right-0 text-center ${activeIndex === index ? 'text-white' : 'text-gray-500'}`}
                  >
                    0{index + 1}
                  </span>
                </button>
            ...
            <div className="flex-1 flex items-center p-8 lg:p-0 lg:pl-24">
              <div className="flex flex-col items-start text-left w-full max-w-5xl">
                {/* Heading */}
              <h3 className="text-[#00FFD2] font-medium text-[52px] leading-[49.7px] tracking-[-3.8px] align-middle mb-8">
                {activeSolution.heading}
              </h3>
              {/* Description */}
              <p className="text-white font-medium text-[46px] leading-[49.7px] tracking-[-3.8px] align-middle">
